...
export default function PrePayrollPage() {
  ...
  return <main className="p-4 md:p-8 max-w-7xl mx-auto flex flex-col gap-6">
    <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
      ...
      <p className="text-zinc-400 mt-2">Hechos de asistencia reales primero. Workforce mantiene aquí una capa básica de pre‑nómina, sin motor avanzado de liquidación.</p></div>
    ...
    <div className="rounded-2xl border border-blue-500/20 bg-blue-500/5 p-5 text-sm text-zinc-300">
      <strong className="text-blue-300">Alcance de Workforce:</strong> esta vista consolida hechos reales de asistencia y novedades para revisión previa. El motor avanzado de liquidación, reglas versionadas y cierre de períodos vive en el producto separado InnerSpark Payroll AI.
    </div>
  </main>;
}
