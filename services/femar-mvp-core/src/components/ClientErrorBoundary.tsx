...
export default class ClientErrorBoundary extends React.Component<Props, State> {
  ...
  render() {
    ...
    return (
      <div className="rounded-xl border border-amber-500/30 bg-amber-500/10 p-5 text-amber-100 m-4">
        ...
        <p className="text-sm text-amber-100/80 mb-4">
          This section failed to load, but the rest of the application is active.
        </p>
