...
export const JUDGE_DEMO_STEPS: JudgeDemoStep[] = [
  ...
  {
    id: 'a2a_cards',
    labelEn: '3 · Agent Cards catalog (58)',
    action: 'a2a_cards',
    payload: { limit: 8 },
    agent: 'MCP → AG cards registry',
    protocol: 'a2a_agent_cards',
    evidenceMongo: 'agent_activity',
    purpose: 'Expose the multi-agent catalog judges can inspect (58 cards on live fleet).',
    expectedFlow: 'Card list or count appears; no timeout from proxy.',
    passCriteria: 'cards count > 0 (list or dict).',
  },
  {
    id: 'emergency_pdf',
  ...
  },
  {
    ...
    expectedFlow: 'Dispatch accepted; task_id or dry_run flag in response; A2A proof panel shows chain.',
